...
public class WoodRod extends FishingRodItem {

    public WoodRod(Properties properties) {
        super(properties);
    }
    ...
    public void onStopUsing(ItemStack stack, LivingEntity entity, int count){
            System.out.println("Stopped using Wood Rod");
            time = 0;
            fishing = false;
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if(time == 2) {
            /*
            if(itemstack.getItem().equals(ModItems.WOODROD.get())) {
            ...
            if(player1.getSlot(99).get().getItem().equals(ModItems.WORM.get()) ||
                ...
                if(n==1) {
                    player1.getSlot(99).get().setCount(player1.getSlot(99).get().getCount() - 1);
