...
public class SetBambooWormModifier extends LootModifier {
    ...
    public static Supplier<MapCodec<SetBambooWormModifier>> CODEC_SUPPLIER = Suppliers.memoize(() -> RecordCodecBuilder
            .mapCodec(instance -> SetBambooWormModifier.codecStart(instance)
    ...
    public SetBambooWormModifier(LootItemCondition[] conditionsIn, Item item1, Item item2, Item item3, Item item4 , Item item5) {
        super(conditionsIn);
        this.item1 = item1;
        this.item2 = item2;
        this.item3 = item3;
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        if(rand.nextInt(2)==1) return new ObjectArrayList<ItemStack>(Collections.singleton(new ItemStack(this.item2)));
        else if(rand.nextInt(8)==1) return new ObjectArrayList<ItemStack>(Collections.singleton(new ItemStack(this.item1)));
